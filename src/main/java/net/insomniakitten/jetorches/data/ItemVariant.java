...
public enum ItemVariant implements IStringSerializable, OreNameSupplier {
    ...
    public static final ItemVariant[] VALUES = values();

    private final String ore;
    private final int size;

    ItemVariant(String ore, int size) {
        this.size = size;
        this.ore = ore;
    }

    ItemVariant(String ore) {
        this(ore, 64);
    }
